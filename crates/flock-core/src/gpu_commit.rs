    ...
    unsafe fn run_commit_graph_from_z_hybrid_impl(
        ...
        unsafe {
            ...
            let r = (|| {
                ...
                let wall_off = run_hybrid_cpu_suffix(
                    ntt,
                    data,
                    tree_base,
                    n_leaves,
                ...
                if suffix_offload_calibration_pending() {
                    // Replay the suffix with the offload forced; it rewrites
                    // byte-identical leaves/parents, and the suffix-wall
                    // verdict decides the latch.
                    let wall_on = run_hybrid_cpu_suffix(
                        ntt,
                        data,
                        tree_base,
                        n_leaves,
