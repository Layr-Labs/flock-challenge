...
/// Same-binary A/B kill switch shared with the lookahead driver. When set,
/// the Metal kernel retains the incumbent four-product workload rather than
/// wasting cycles on outputs the CPU was explicitly asked to recompute.
...
"#;
    ...
    fn zc_r2_gate_share_policy() {
        ...
        // The default full-lookahead arm uses its conservative quarter cap.
        assert_eq!(zc_r2_gate_share(0.57, 2048), 512);
        assert_eq!(zc_r2_gate_share(0.38, 2048), 512);
        assert_eq!(zc_r2_gate_share(0.62, 2048), 512);
        assert_eq!(zc_r2_gate_share(1.0, 2048), 512);
        assert_eq!(zc_r2_gate_share(2.0, 2048), 512);
