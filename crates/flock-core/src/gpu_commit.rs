...
/// Same-binary kill switch for the ranked 11/16 hybrid-prefix Merkle
/// schedule. Only the exact value `1` disables it; the ranked-tree, k=5, and
/// parent3 geometry checks still gate production selection.
