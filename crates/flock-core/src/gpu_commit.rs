                      ...
                      uint lid  [[thread_index_in_threadgroup]])
{
    ...
    if (lid < nf - 1u) {
        ...
        tabs[(t << 5) + 5u]  = c0 ^ c2;
        tabs[(t << 5) + 6u]  = c1 ^ c2;
        tabs[(t << 5) + 7u]  = c0 ^ c1 ^ c2;
        tabs[(t << 5) + 8u]  = c3;
        tabs[(t << 5) + 9u]  = c0 ^ c3;
        tabs[(t << 5) + 10u] = c1 ^ c3;
        tabs[(t << 5) + 11u] = c0 ^ c1 ^ c3;
        tabs[(t << 5) + 12u] = c2 ^ c3;
        tabs[(t << 5) + 13u] = c0 ^ c2 ^ c3;
        tabs[(t << 5) + 14u] = c1 ^ c2 ^ c3;
        tabs[(t << 5) + 15u] = c0 ^ c1 ^ c2 ^ c3;
        tabs[(t << 5) + 16u] = uint4(0u);
        tabs[(t << 5) + 17u] = d0;
        tabs[(t << 5) + 18u] = d1;
        tabs[(t << 5) + 19u] = d0 ^ d1;
        tabs[(t << 5) + 20u] = d2;
        tabs[(t << 5) + 21u] = d0 ^ d2;
        tabs[(t << 5) + 22u] = d1 ^ d2;
        tabs[(t << 5) + 23u] = d0 ^ d1 ^ d2;
        tabs[(t << 5) + 24u] = d3;
        tabs[(t << 5) + 25u] = d0 ^ d3;
        tabs[(t << 5) + 26u] = d1 ^ d3;
        tabs[(t << 5) + 27u] = d0 ^ d1 ^ d3;
        tabs[(t << 5) + 28u] = d2 ^ d3;
        tabs[(t << 5) + 29u] = d0 ^ d2 ^ d3;
        tabs[(t << 5) + 30u] = d1 ^ d2 ^ d3;
        tabs[(t << 5) + 31u] = d0 ^ d1 ^ d2 ^ d3;
    }
...
{                                                                              \
    ...
    if (lid < NTW * 4u) {                                                    \
        ...
        tabs[(lid << 4) + 5u]  = c0 ^ c2;                                     \
        tabs[(lid << 4) + 6u]  = c1 ^ c2;                                     \
        tabs[(lid << 4) + 7u]  = c0 ^ c1 ^ c2;                                \
        tabs[(lid << 4) + 8u]  = c3;                                          \
        tabs[(lid << 4) + 9u]  = c0 ^ c3;                                     \
        tabs[(lid << 4) + 10u] = c1 ^ c3;                                     \
        tabs[(lid << 4) + 11u] = c0 ^ c1 ^ c3;                                \
        tabs[(lid << 4) + 12u] = c2 ^ c3;                                     \
        tabs[(lid << 4) + 13u] = c0 ^ c2 ^ c3;                                \
        tabs[(lid << 4) + 14u] = c1 ^ c2 ^ c3;                                \
        tabs[(lid << 4) + 15u] = c0 ^ c1 ^ c2 ^ c3;                           \
    }                                                                        \
    threadgroup_barrier(mem_flags::mem_threadgroup);                         \
                                                                               \
