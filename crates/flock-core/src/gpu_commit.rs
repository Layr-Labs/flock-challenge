    ...
    unsafe fn run_commit_graph_from_z_hybrid_impl(
        ...
        unsafe {
            ...
            let r = (|| {
                ...
                // E-core offload is diagnostic-only (FLOCK_ZC_SUFFIX_OFFLOAD=1):
                // automatic engagement is disabled until a calibration that is
                // unbiased by GPU cold/warm asymmetry exists.
