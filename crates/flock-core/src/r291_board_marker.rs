...
//! gin-research-resample-04: fourth bytecode-identical timing sample of the folded-capture candidate.
//! gin-research-resample-05: fifth bytecode-identical timing sample of the folded-capture candidate.
//! gin-research-resample-06: sixth bytecode-identical timing sample of the folded-capture candidate.
//! gin-research-resample-07: seventh bytecode-identical timing sample of the folded-capture candidate.
//! gin-research-resample-08: eighth bytecode-identical timing sample of the folded-capture candidate.
//! gin-research-resample-09: ninth bytecode-identical timing sample of the folded-capture candidate.
//! gin-research-resample-10: tenth bytecode-identical timing sample of the folded-capture candidate.
