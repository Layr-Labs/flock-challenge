...
// Validation provenance: 7cdb8f8 fully verified at 1,538,636.271; executable
// logic is unchanged for the single disclosed resample of that near-frontier draw.
