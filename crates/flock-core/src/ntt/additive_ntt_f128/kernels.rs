...
/// AArch64 specialization for a fused pair whose inner twiddles have high
/// limbs below 32. Other targets retain the ordinary field-multiply kernel.
#[allow(clippy::too_many_arguments)]
#[inline]
pub(super) fn butterfly_fused_2layer_tiny_inner_twiddles(
    a: &mut [F128],
    b: &mut [F128],
    c: &mut [F128],
    d: &mut [F128],
    ...
    #[cfg(all(target_arch = "aarch64", target_feature = "aes"))]
    unsafe {
        aarch64::butterfly_fused_2layer_tiny_inner_twiddles(
