...
/// group in an L1-resident `tile` of `72 * num_ntts` elements (64 rows of
/// staging plus 8 rows for the second sweep's store bursts). Bit-identical
...
/// writable for `72 * num_ntts` elements and private to this call, and
