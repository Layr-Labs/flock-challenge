...
/// Keep the 1024-job depth, but dispatch slabs in 10-bit Gray-code order.
/// Gray code is a bijection and changes only one job-index bit per claim, while
/// accesses remain contiguous inside every queue-owned slab.
#[inline]
