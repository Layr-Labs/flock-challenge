...
#[inline(never)]
#[allow(clippy::too_many_arguments)]
fn precompute_ab_hetero<const FAST_POLICY: u8, const FORCE_DIRECT: bool, const STATIC_LAYOUT: bool>(
    a_packed: &[u8],
    b_packed: &[u8],
    inv_table: &InvNttTableByteSingleGf8,
    ...
    crate::epool::run_hetero_chunks_stateful(
        ...
        |(a_col, b_col), block| {
            ...
            for (offset, out_outer) in out_block.chunks_exact_mut(OUTER_BYTES).enumerate() {
                ...
                precompute_ab_one_chunk::<FAST_POLICY, FORCE_DIRECT, STATIC_LAYOUT>(
                    a_packed,
                    b_packed,
                    inv_table,
                    within_outer_mask,
...
#[inline(always)]
#[allow(clippy::too_many_arguments)]
fn precompute_ab_one_chunk<const FAST_POLICY: u8, const FORCE_DIRECT: bool, const STATIC_LAYOUT: bool>(
    a_packed: &[u8],
    b_packed: &[u8],
    inv_table: &InvNttTableByteSingleGf8,
    within_outer_mask: usize,
