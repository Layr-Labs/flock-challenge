...
/// Jobs of this many 1 KiB chunks feed the QS5 hetero precompute queue. Forty
/// reduces heterogeneous tail latency while retaining enough work to amortize
/// each atomic claim.
const AB_PRE_CHUNKS_PER_JOB: usize = 40;
