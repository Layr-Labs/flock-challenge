...
// r802 bar-tree resample marker: 20260807T0251Z; semantics unchanged.
// r800 drew -0.03% on this exact tree; second independent bar-tree draw after the r801 512-seq reject.
