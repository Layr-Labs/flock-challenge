...
/// no ordinary basis, and 256 independent 32 KiB output blocks. This is
...
fn materialize_direct_fold8(
    ...
    let stats = if let Some(helper) = helper {
        ...
        let f_base = crate::epool::SyncPtr(folded_f.as_mut_ptr());
        let partials_base = crate::epool::SyncPtr(partials.as_mut_ptr());
        crate::epool::run_chunks_with_helper_stateful_capped_prefix(
            n_blocks,
            4,
            &|| vec![F128::ZERO; super::ring_switch::FOLD_TABLE_LEN],
...
mod tests {
    ...
    fn ranked_direct_fold8_materialize_shape_is_exact() {
        assert_eq!(
            super::super::ring_switch::deferred_split_n_lo(19),
            11,
            "ranked Fold8 factors use 256 blocks of 2^11 field elements",
        );
