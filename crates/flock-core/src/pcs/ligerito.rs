...
// Akashneelesh static-A-first dispatch submission (2026-08-06): functional change in
// zerocheck/univariate_skip_optimized/kernels/aarch64.rs only; this line is a lineage marker.
