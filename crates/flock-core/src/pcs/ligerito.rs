...
// RealAdii self-extension draw on e53696f.
// RealAdii self-extension draw 2 on e53696f (draw 1: 1,241,804.63).
// RealAdii self-extension draw 3 on e53696f (draws: 1,241,804.63 / 1,243,178.87).
