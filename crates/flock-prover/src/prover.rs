...
pub fn prove_fast_ligerito_from_witness<Ch: Challenger>(
    ...
    prove_fast_ligerito_from_witness_input(
        r1cs,
        pcs_params,
        z_packed,
        a_packed_f128,
...
/// Row-major fast path: lincheck consumes the canonical PCS witness directly.
...
#[allow(clippy::too_many_arguments)]
fn prove_fast_ligerito_from_witness_input<Ch: Challenger>(
    r1cs: &BlockR1cs,
    pcs_params: &PcsParams,
    z_packed: Vec<F128>,
    a_packed_f128: Vec<F128>,
    ...
    let ProveCore {
        ...
        Some(stripe) => prove_fast_core_with_codeword(
            r1cs,
            pcs_params,
            z_packed,
            a_packed_f128,
        ...
        None => prove_fast_core_with_codeword_row_major(
            r1cs,
            pcs_params,
            z_packed,
            a_packed_f128,
