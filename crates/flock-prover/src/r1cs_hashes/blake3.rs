...
impl Blake3Setup {
    ...
    /// Ranked-only virtual-input replacement for the hot `[z,z]` write.
    /// `FLOCK_NO_RATE2_VIRTUAL_INIT=1` restores the exact preinitialized
    /// codeword path for A/B measurements and diagnostics.
    #[inline]
